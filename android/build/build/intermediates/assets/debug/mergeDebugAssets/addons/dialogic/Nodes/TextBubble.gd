...
func update_name(name: String, color: Color = Color.WHITE, autocolor: bool=false) -> void:
	...
	if not name.is_empty():
		...
		name_label.size = name_label.get_font("font").get_string_size(name_label.text)
		name_label.custom_minimum_size = name_label.get_font("font").get_string_size(name_label.text)
		# Alignment
